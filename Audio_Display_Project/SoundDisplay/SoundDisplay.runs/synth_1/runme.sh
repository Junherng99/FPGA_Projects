...
HD_PWD='C:/Users/junhe/Desktop/School/Y3/EE2026/SoundDisplay/SoundDisplay/SoundDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Improvements_Compiled.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Improvements_Compiled.tcl

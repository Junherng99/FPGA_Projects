...
HD_PWD='C:/Users/junhe/Desktop/School/Y3/EE2026/SoundDisplay/SoundDisplay/SoundDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Improvements_Compiled.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Improvements_Compiled.tcl -notrace

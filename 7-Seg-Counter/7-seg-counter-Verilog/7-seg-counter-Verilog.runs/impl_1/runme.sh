...
HD_PWD='C:/Users/junhe/Desktop/work/My Documents/Projects/FPGA/Vivado Files/7-seg-counter-Verilog/7-seg-counter-Verilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_digit_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source four_digit_counter.tcl -notrace

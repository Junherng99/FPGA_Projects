...
HD_PWD='C:/Users/junhe/Desktop/work/My Documents/Projects/FPGA/Vivado Files/7-seg-counter-Verilog/7-seg-counter-Verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_digit_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_digit_counter.tcl
